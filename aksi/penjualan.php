    ...
    if($_POST){
        if($_POST['aksi']=='tambah-keranjang-bybarcode'){
            ...
            if(mysqli_num_rows($query1)>=1){
                // echo "Produk Di Temukan Di Database";
                $ProdukID=$Produk['ProdukID'];
                // cek keranjangn bila produk sudah ada hanya meng-update jumlah, bila belumada akan insert data
            ...
            if(mysqli_query($koneksi,$sql1)){
                ...
                // mengambil PenjualanID dari table penjualan
                ...
                // menyimpan data produk yang di beli ke table detailpenjualan yang diambil dari tabel keranjang
